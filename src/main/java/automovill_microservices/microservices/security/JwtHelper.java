package automovill_microservices.microservices.security;
...
public class JwtHelper {
    ...
    private String secret = "sgdhjasgdhjasdashdgahsjqwfasxASFACASDFACASDFASFASFDAFASFASDAADSCSDFADCVSGCFVADXCcadwavfsfarvf";
